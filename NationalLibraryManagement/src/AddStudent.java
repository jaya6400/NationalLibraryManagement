...
public class AddStudent extends JFrame implements ActionListener{
	...
	comboBox = new JComboBox<>(new String[] { "Mechanical", "CSE", "IT", "Civil", "Automobile", "EEE", "Other" });
	...
	comboBox_1 = new JComboBox<>(new String[] { "First", "Second", "Third", "Four" });
	...
	comboBox_2 = new JComboBox<>(new String[] { "1st", "2nd", "3rd", "4th", "5th", "6th", "7th", "8th" });
	...
	comboBox_3 = new JComboBox<>(new String[] { "B.E", "B.Tech", "M.Tech", "MBA", "BBA", "BCA", "B.Sc", "M.Sc", "B.Com", "M.Com" });
